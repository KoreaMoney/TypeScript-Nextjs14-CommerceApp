...
const Slider = () => {
  const slides = [
    ...
    },
    {
      ...
      description: "Sale! Up to 35% off!",
      img: "https://images.pexels.com/photos/1021693/pexels-photo-1021693.jpeg?auto=compress&cs=tinysrgb&w=800",
      url: "/",
      bg: "bg-gradient-to-r from-yellow-50 to-blue-100",
    },
    {
      id: 3,
  ...
  return (
    <div className="h-[calc(100dvh-80px)] overflow-hidden">
      <div
        ...
        style={{ transform: `translateX(-${current * 100}dvw)` }}
      >
        {slides.map((slide) => (
          <div className={`${slide.bg} w-screen h-full flex flex-col gap-16 xl:flex-row`} key={slide.id}>
            ...
            {/* IMAGE CONTAINER */}
            <div className="relative xl:w-1/2 xl:h-full h-1/2">
