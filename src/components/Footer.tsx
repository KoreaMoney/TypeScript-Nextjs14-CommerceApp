    ...
    <div className="px-4 py-24 md:px-8 lg:px-16 xl:px-32 2xl:px-64 bg-gray-100 text-sm mt-24">
      ...
      <div className="flex flex-col md:flex-row justify-between gap-24">
        ...
        <div className="w-full md:W-1/2 lg:w-1/4 flex flex-col gap-8">
          ...
          <p>Vercel Inc. 123 Townsend St. San Francisco, CA 94107 United States</p>
          <span className="font-semibold">vercelDowon@gmail.com</span>
          <span className="font-semibold">+82 10-1354-4879</span>
        ...
        <div className="w-full md:W-1/2 lg:w-1/4 flex flex-col gap-8">
          ...
          <div className="flex">
            ...
            <button className="w-1/4 bg-alarm text-white">Join</button>
          </div>
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-8 mt-16">
        <div className="">© Copyright 2024 DWSH. All rights reserved.</div>
        <div className="flex flex-col gap-8 md:flex-row">
          <div className="">
            <span className="text-gray-500 mr-4">Language</span>
            <span className="font-medium">South Korea | English</span>
          </div>
          <div className="">
